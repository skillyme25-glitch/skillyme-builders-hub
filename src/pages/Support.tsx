...
type Category = "Submissions" | "Platform" | "Mentors" | "Payments" | "Gala";

interface FAQ { q: string; a: string; cat: Category }
...
const CATEGORIES: Category[] = ["Submissions", "Platform", "Mentors", "Payments", "Gala"];
